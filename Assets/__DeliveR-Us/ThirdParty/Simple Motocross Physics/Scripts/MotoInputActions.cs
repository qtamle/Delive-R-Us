...
//     version 1.14.2
//     from Assets/__DeliveR-Us/ThirdParty/Simple Motocross Physics/Scripts/MotoInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/__DeliveR-Us/ThirdParty/Simple Motocross Physics/Scripts/MotoInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @MotoInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@MotoInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, MotoInputActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, MotoInputActions.UI.Disable() has not been called.");
    }
    ...
    public struct PlayerActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Player/Wheelie".
        /// </summary>
